...
public class ObstacleRondMouvant extends Obstacle {
	...
	/**
	 * @param limites_x
	 *            Définit les limites du mouvement de l'obstacle sur l'axe x
	 * @param limites_y
	 *            Définit les limites du mouvement de l'obstacle sur l'axe y
	 *            limites_x[0] et limites_y[0] doivent être égales aux
	 *            coordonées de départ de l'obstacle.
	 */
